...
## Overview
This project evaluated the effectiveness of incorporating spatial dependence into time series forecasting of monthly temperature data using a Space–Time Autoregressive Integrated Moving Average (STARIMA) model, compared to traditional ARIMA models. Using observations from 274 weather stations across the Mid-Atlantic United States (2000–2015), the analysis examined whether spatial structure improves medium-term climate forecasting accuracy beyond seasonality alone.
